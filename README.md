# StudyNotion Online Education Platform (MERN App) [Website Link](https://study-notion-edtech-plaform.vercel.app/)
...
* Course Details: This page now dynamically shows an "Add to Cart" button for unenrolled courses and a "Go to Course" button for enrolled ones.
...
to the platform using their email addresses and password. A default profile image is automatically generated upon signup. The platform also supports
